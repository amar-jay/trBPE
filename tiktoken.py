# from tiktoken import bpe_train
# I have trouble importing tiktoken._educational, CTRL-C
...
def bpe_train(
    ...
    if visualise:
        ...
        if visualise in ["colour", "color"]:
            ...
            visualise_tokens([token for word in words[-100:] for token in word])
            #visualise_tokens([token for token in words[-1]])
        elif visualise == "simple":
...
if __name__ == "__main__":
    print(">>> enc ", train_simple_encoding())
